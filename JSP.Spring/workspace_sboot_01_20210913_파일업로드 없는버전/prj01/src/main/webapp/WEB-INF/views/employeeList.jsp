...
<body onkeydown="if(event.keyCode==13) {search();}">
    ...
    <form name="boardListForm" method="post" onsubmit="return false;">
            ...
            <!-- --------------------------------------------------- -->
            [직원검색]
            <table border="1" class="tbcss2" style="border-collapse:collapse" cellpadding="4">
                <tr>
                    <th> 
                        키워드 
                    </th>
    ...
    <div style="height: 5px;"></div> <!-- 공백조절용 div 태그 -->
    ...
    <div class="searchResult">
        ...
        <table border="1" class="tbcss0" style="border-collapse:collapse" cellpadding="4">
            <tr bgcolor="gray">
                <th>번호</th><th>직원번호</th><th>직원명</th><th>직급</th><th>입사일</th><th>소속부서명</th></tr>
            ...
            <c:forEach var="board" items="${requestScope.boardList}" varStatus="loopTagStatus">
                ...
                <tr bgcolor="${loopTagStatus.index%2==0?'white':'lightgray'}" 
                    ...
                    <td><!-- 직원명 출력 -->${board.writer}</td>
                    <td><!-- 직급 출력 -->${board.readcount}</td>
                    <td><!-- 입사일 출력 -->${board.reg_date}</td>
                    <td><!-- 소속부서명 출력 -->${board.reg_date}</td>
